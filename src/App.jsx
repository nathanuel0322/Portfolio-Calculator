          ...
          await signInWithEmailAndPassword(auth, email, password)
            .then(() => {
              alert("Signed in!", "", [
                {
                  text: "OK",
                  onClick: () => console.log("User account signed in!"),
                },
              ]);
              return true;
            })
                ...
                alert("There is no user account linked to this email!", "", [
                  {
                    ...
                    onClick: () =>
                      console.log(
                        "There is no user account linked to this email!"
                      ),
                  },
                ]);
              }
            ...
            .catch((error) => {
              ...
              if (error.code === "auth/invalid-email") {
                alert("That email address is invalid!", "", [
                  {
                    text: "OK",
                    onClick: () => console.log("auth/invalid-email"),
                  },
                ]);
              }
              if (error.code === "auth/operation-not-allowed") {
                alert("Sorry, you can't do that right now.", "", [
                  {
                    text: "OK",
                    onClick: () => console.log("auth/operation-not-allowed"),
                  },
                ]);
              }
